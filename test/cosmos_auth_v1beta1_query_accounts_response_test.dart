...
// tests for CosmosAuthV1beta1QueryAccountsResponse
void main() {
  // final instance = CosmosAuthV1beta1QueryAccountsResponse();

  group('test CosmosAuthV1beta1QueryAccountsResponse', () {

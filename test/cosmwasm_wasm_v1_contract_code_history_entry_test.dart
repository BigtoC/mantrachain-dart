...
// tests for CosmwasmWasmV1ContractCodeHistoryEntry
void main() {
  // final instance = CosmwasmWasmV1ContractCodeHistoryEntry();

  group('test CosmwasmWasmV1ContractCodeHistoryEntry', () {

...
// tests for DenomUnitsRepresentsTheListOfDenomUnitSForAGivenCoinInner
void main() {
  // final instance = DenomUnitsRepresentsTheListOfDenomUnitSForAGivenCoinInner();

  group('test DenomUnitsRepresentsTheListOfDenomUnitSForAGivenCoinInner', () {

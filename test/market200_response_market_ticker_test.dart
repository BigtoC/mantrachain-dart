...
// tests for Market200ResponseMarketTicker
void main() {
  // final instance = Market200ResponseMarketTicker();

  group('test Market200ResponseMarketTicker', () {
    ...
    test('to test the property `minProviderCount`', () async {
      // TODO
    });

...
// tests for CosmosSlashingV1beta1ValidatorSigningInfo
void main() {
  // final instance = CosmosSlashingV1beta1ValidatorSigningInfo();

  group('test CosmosSlashingV1beta1ValidatorSigningInfo', () {
    // String address

...
// tests for BodyIsTheProcessableContentOfTheTransaction
void main() {
  // final instance = BodyIsTheProcessableContentOfTheTransaction();

  group('test BodyIsTheProcessableContentOfTheTransaction', () {

...
// tests for CosmosTxV1beta1BroadcastTxRequest
void main() {
  // final instance = CosmosTxV1beta1BroadcastTxRequest();

  group('test CosmosTxV1beta1BroadcastTxRequest', () {
    // tx_bytes is the raw transaction.
    // String txBytes
    test('to test the property `txBytes`', () async {
      // TODO
    });
    ...
    // String mode (default value: 'BROADCAST_MODE_UNSPECIFIED')

...
// tests for CosmosTxV1beta1GetBlockWithTxsResponseBlock
void main() {
  // final instance = CosmosTxV1beta1GetBlockWithTxsResponseBlock();

  group('test CosmosTxV1beta1GetBlockWithTxsResponseBlock', () {
    ...
    test('to test the property `lastCommit`', () async {
      // TODO
    });

...
// tests for QueryContractHistoryResponseIsTheResponseTypeForTheQueryContractHistoryRPCMethodEntriesInner
void main() {
  // final instance = QueryContractHistoryResponseIsTheResponseTypeForTheQueryContractHistoryRPCMethodEntriesInner();

  group('test QueryContractHistoryResponseIsTheResponseTypeForTheQueryContractHistoryRPCMethodEntriesInner', () {
    ...
    // String operation (default value: 'CONTRACT_CODE_HISTORY_OPERATION_TYPE_UNSPECIFIED')
    test('to test the property `operation`', () async {
      // TODO
    });

    // String codeId
    test('to test the property `codeId`', () async {
      // TODO
    });

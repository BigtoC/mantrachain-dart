...
// tests for WasmParams200ResponseParams
void main() {
  // final instance = WasmParams200ResponseParams();

  group('test WasmParams200ResponseParams', () {
    // CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission codeUploadAccess
    test('to test the property `codeUploadAccess`', () async {
      // TODO
    });
    ...
    // String instantiateDefaultPermission (default value: 'ACCESS_TYPE_UNSPECIFIED')
    test('to test the property `instantiateDefaultPermission`', () async {
      // TODO
    });

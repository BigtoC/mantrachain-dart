...
// tests for ConnectionParams200ResponseParams
void main() {
  // final instance = ConnectionParams200ResponseParams();

  group('test ConnectionParams200ResponseParams', () {
    ...
    test('to test the property `maxExpectedTimePerBlock`', () async {
      // TODO
    });

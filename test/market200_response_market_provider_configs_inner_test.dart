...
// tests for Market200ResponseMarketProviderConfigsInner
void main() {
  // final instance = Market200ResponseMarketProviderConfigsInner();

  group('test Market200ResponseMarketProviderConfigsInner', () {
    ...
    test('to test the property `offChainTicker`', () async {
      // TODO
    });

    // CurrencyPairIsTheStandardRepresentationOfAPairOfAssetsWhereOneBaseIsPricedInTermsOfTheOtherQuote1 normalizeByPair
    test('to test the property `normalizeByPair`', () async {
      // TODO
    });

    // bool invert
    test('to test the property `invert`', () async {
      // TODO
    });

...
// tests for IbcCoreClientV1QueryVerifyMembershipRequest
void main() {
  // final instance = IbcCoreClientV1QueryVerifyMembershipRequest();

  group('test IbcCoreClientV1QueryVerifyMembershipRequest', () {

...
Generation Command:
```shell
openapi-generator-cli generate -i https://raw.githubusercontent.com/MANTRA-Chain/mantrachain/refs/heads/main/client/docs/static/swagger/swagger.yaml -g dart
```
...
*QueryApi* | [**channelParams**](doc//QueryApi.md#channelparams) | **GET** /ibc/core/channel/v1/params | ChannelParams queries all parameters of the ibc channel submodule.
...
*QueryApi* | [**counterpartyPayee**](doc//QueryApi.md#counterpartypayee) | **GET** /ibc/apps/fee/v1/channels/{channel_id}/relayers/{relayer}/counterparty_payee | CounterpartyPayee returns the registered counterparty payee for forward relaying
...
*QueryApi* | [**denomTrace**](doc//QueryApi.md#denomtrace) | **GET** /ibc/apps/transfer/v1/denom_traces/{hash} | DenomTrace queries a denomination trace information.
*QueryApi* | [**denomTraces**](doc//QueryApi.md#denomtraces) | **GET** /ibc/apps/transfer/v1/denom_traces | DenomTraces queries all denomination traces.
...
*QueryApi* | [**feeEnabledChannel**](doc//QueryApi.md#feeenabledchannel) | **GET** /ibc/apps/fee/v1/channels/{channel_id}/ports/{port_id}/fee_enabled | FeeEnabledChannel returns true if the provided port and channel identifiers belong to a fee enabled channel
*QueryApi* | [**feeEnabledChannels**](doc//QueryApi.md#feeenabledchannels) | **GET** /ibc/apps/fee/v1/fee_enabled | FeeEnabledChannels returns a list of all fee enabled channels
*QueryApi* | [**feemarketParams**](doc//QueryApi.md#feemarketparams) | **GET** /feemarket/v1/params | Params returns the current feemarket module parameters.
*QueryApi* | [**gasPrice**](doc//QueryApi.md#gasprice) | **GET** /feemarket/v1/gas_price/{denom} | GasPrice returns the current feemarket module gas price for specified denom.
*QueryApi* | [**gasPrices**](doc//QueryApi.md#gasprices) | **GET** /feemarket/v1/gas_prices | GasPrices returns the current feemarket module list of gas prices in all available denoms.
...
*QueryApi* | [**incentivizedPacket**](doc//QueryApi.md#incentivizedpacket) | **GET** /ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/incentivized_packet | IncentivizedPacket returns all packet fees for a packet given its identifier
*QueryApi* | [**incentivizedPackets**](doc//QueryApi.md#incentivizedpackets) | **GET** /ibc/apps/fee/v1/incentivized_packets | IncentivizedPackets returns all incentivized packets and their associated fees
*QueryApi* | [**incentivizedPacketsForChannel**](doc//QueryApi.md#incentivizedpacketsforchannel) | **GET** /ibc/apps/fee/v1/channels/{channel_id}/ports/{port_id}/incentivized_packets | Gets all incentivized packets for a specific channel
...
*QueryApi* | [**payee**](doc//QueryApi.md#payee) | **GET** /ibc/apps/fee/v1/channels/{channel_id}/relayers/{relayer}/payee | Payee returns the registered payee address for a specific channel given the relayer address
...
*QueryApi* | [**rateLimit**](doc//QueryApi.md#ratelimit) | **GET** /Stride-Labs/ibc-rate-limiting/ratelimit/ratelimit/{channel_id}/by_denom | Queries a specific rate limit by channel ID and denom Ex:  - /ratelimit/{channel_id}/by_denom?denom={denom}
...
*QueryApi* | [**rateLimitsByChannelId**](doc//QueryApi.md#ratelimitsbychannelid) | **GET** /Stride-Labs/ibc-rate-limiting/ratelimit/ratelimits/{channel_id} | Queries all the rate limits for a given channel ID
...
*QueryApi* | [**state**](doc//QueryApi.md#state) | **GET** /feemarket/v1/state | State returns the current feemarket module state.
...
*QueryApi* | [**totalAckFees**](doc//QueryApi.md#totalackfees) | **GET** /ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_ack_fees | TotalAckFees returns the total acknowledgement fees for a packet given its identifier
*QueryApi* | [**totalEscrowForDenom**](doc//QueryApi.md#totalescrowfordenom) | **GET** /ibc/apps/transfer/v1/denoms/{denom}/total_escrow | TotalEscrowForDenom returns the total amount of tokens in escrow based on the denom.
*QueryApi* | [**totalRecvFees**](doc//QueryApi.md#totalrecvfees) | **GET** /ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_recv_fees | TotalRecvFees returns the total receive fees for a packet given its identifier
...
*QueryApi* | [**totalTimeoutFees**](doc//QueryApi.md#totaltimeoutfees) | **GET** /ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_timeout_fees | TotalTimeoutFees returns the total timeout fees for a packet given its identifier
...
*QueryApi* | [**upgrade**](doc//QueryApi.md#upgrade) | **GET** /ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/upgrade | Upgrade returns the upgrade for a given port and channel id.
*QueryApi* | [**upgradeError**](doc//QueryApi.md#upgradeerror) | **GET** /ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/upgrade_error | UpgradeError returns the error receipt if the upgrade handshake failed.
...
## Documentation For Models
 ...
 - [BlockHeightAfterWhichThePacketOrUpgradeTimesOut](doc//BlockHeightAfterWhichThePacketOrUpgradeTimesOut.md)
 ...
 - [ChannelParams200Response](doc//ChannelParams200Response.md)
 - [ChannelParams200ResponseParams](doc//ChannelParams200ResponseParams.md)
 ...
 - [CodesDefaultResponse](doc//CodesDefaultResponse.md)
 - [CodesDefaultResponseDetailsInner](doc//CodesDefaultResponseDetailsInner.md)
 ...
 - [DenomTrace200Response](doc//DenomTrace200Response.md)
 - [DenomTraces200Response](doc//DenomTraces200Response.md)
 - [DenomTraces200ResponseDenomTracesInner](doc//DenomTraces200ResponseDenomTracesInner.md)
 ...
 - [FeeEnabledChannelContainsThePortIDChannelIDForAFeeEnabledChannel](doc//FeeEnabledChannelContainsThePortIDChannelIDForAFeeEnabledChannel.md)
 - [FeeEncapsulatesTheRecvAckAndTimeoutFeesAssociatedWithAnIBCPacket](doc//FeeEncapsulatesTheRecvAckAndTimeoutFeesAssociatedWithAnIBCPacket.md)
 - [FeemarketFeemarketV1GasPriceResponse](doc//FeemarketFeemarketV1GasPriceResponse.md)
 - [FeemarketFeemarketV1GasPricesResponse](doc//FeemarketFeemarketV1GasPricesResponse.md)
 - [FeemarketFeemarketV1Params](doc//FeemarketFeemarketV1Params.md)
 - [FeemarketFeemarketV1ParamsResponse](doc//FeemarketFeemarketV1ParamsResponse.md)
 - [FeemarketFeemarketV1State](doc//FeemarketFeemarketV1State.md)
 - [FeemarketFeemarketV1StateResponse](doc//FeemarketFeemarketV1StateResponse.md)
 - [FeemarketParams200Response](doc//FeemarketParams200Response.md)
 - [FeemarketParams200ResponseParams](doc//FeemarketParams200ResponseParams.md)
 - [GasPrice200Response](doc//GasPrice200Response.md)
 - [GasPrice200ResponsePrice](doc//GasPrice200ResponsePrice.md)
 - [GasPrices200Response](doc//GasPrices200Response.md)
 ...
 - [IbcApplicationsFeeV1Fee](doc//IbcApplicationsFeeV1Fee.md)
 - [IbcApplicationsFeeV1FeeEnabledChannel](doc//IbcApplicationsFeeV1FeeEnabledChannel.md)
 - [IbcApplicationsFeeV1IdentifiedPacketFees](doc//IbcApplicationsFeeV1IdentifiedPacketFees.md)
 - [IbcApplicationsFeeV1PacketFee](doc//IbcApplicationsFeeV1PacketFee.md)
 - [IbcApplicationsFeeV1QueryCounterpartyPayeeResponse](doc//IbcApplicationsFeeV1QueryCounterpartyPayeeResponse.md)
 - [IbcApplicationsFeeV1QueryFeeEnabledChannelResponse](doc//IbcApplicationsFeeV1QueryFeeEnabledChannelResponse.md)
 - [IbcApplicationsFeeV1QueryFeeEnabledChannelsResponse](doc//IbcApplicationsFeeV1QueryFeeEnabledChannelsResponse.md)
 - [IbcApplicationsFeeV1QueryIncentivizedPacketResponse](doc//IbcApplicationsFeeV1QueryIncentivizedPacketResponse.md)
 - [IbcApplicationsFeeV1QueryIncentivizedPacketsForChannelResponse](doc//IbcApplicationsFeeV1QueryIncentivizedPacketsForChannelResponse.md)
 - [IbcApplicationsFeeV1QueryIncentivizedPacketsResponse](doc//IbcApplicationsFeeV1QueryIncentivizedPacketsResponse.md)
 - [IbcApplicationsFeeV1QueryPayeeResponse](doc//IbcApplicationsFeeV1QueryPayeeResponse.md)
 - [IbcApplicationsFeeV1QueryTotalAckFeesResponse](doc//IbcApplicationsFeeV1QueryTotalAckFeesResponse.md)
 - [IbcApplicationsFeeV1QueryTotalRecvFeesResponse](doc//IbcApplicationsFeeV1QueryTotalRecvFeesResponse.md)
 - [IbcApplicationsFeeV1QueryTotalTimeoutFeesResponse](doc//IbcApplicationsFeeV1QueryTotalTimeoutFeesResponse.md)
 ...
 - [IbcApplicationsTransferV1DenomTrace](doc//IbcApplicationsTransferV1DenomTrace.md)
 ...
 - [IbcApplicationsTransferV1QueryDenomTraceResponse](doc//IbcApplicationsTransferV1QueryDenomTraceResponse.md)
 - [IbcApplicationsTransferV1QueryDenomTracesResponse](doc//IbcApplicationsTransferV1QueryDenomTracesResponse.md)
 ...
 - [IbcCoreChannelV1ErrorReceipt](doc//IbcCoreChannelV1ErrorReceipt.md)
 ...
 - [IbcCoreChannelV1PacketId](doc//IbcCoreChannelV1PacketId.md)
 - [IbcCoreChannelV1PacketState](doc//IbcCoreChannelV1PacketState.md)
 - [IbcCoreChannelV1Params](doc//IbcCoreChannelV1Params.md)
 ...
 - [IbcCoreChannelV1QueryChannelParamsResponse](doc//IbcCoreChannelV1QueryChannelParamsResponse.md)
 ...
 - [IbcCoreChannelV1QueryUpgradeErrorResponse](doc//IbcCoreChannelV1QueryUpgradeErrorResponse.md)
 - [IbcCoreChannelV1QueryUpgradeResponse](doc//IbcCoreChannelV1QueryUpgradeResponse.md)
 - [IbcCoreChannelV1State](doc//IbcCoreChannelV1State.md)
 - [IbcCoreChannelV1Timeout](doc//IbcCoreChannelV1Timeout.md)
 - [IbcCoreChannelV1Upgrade](doc//IbcCoreChannelV1Upgrade.md)
 - [IbcCoreChannelV1UpgradeFields](doc//IbcCoreChannelV1UpgradeFields.md)
 ...
 - [IbcCoreCommitmentV1MerklePath](doc//IbcCoreCommitmentV1MerklePath.md)
 ...
 - [IdentifiedPacketFeesContainsAListOfTypePacketFeeAndAssociatedPacketId](doc//IdentifiedPacketFeesContainsAListOfTypePacketFeeAndAssociatedPacketId.md)
 ...
 - [LastUpdatedDefaultResponse](doc//LastUpdatedDefaultResponse.md)
 - [LastUpdatedDefaultResponseDetailsInner](doc//LastUpdatedDefaultResponseDetailsInner.md)
 ...
 - [MerklePathIsThePathUsedToVerifyCommitmentProofsWhichCanBeAnArbitraryStructuredObjectDefinedByACommitmentTypeMerklePathIsRepresentedFromRootToLeaf](doc//MerklePathIsThePathUsedToVerifyCommitmentProofsWhichCanBeAnArbitraryStructuredObjectDefinedByACommitmentTypeMerklePathIsRepresentedFromRootToLeaf.md)
 ...
 - [PacketFeeContainsICS29RelayerFeesRefundAddressAndOptionalListOfPermittedRelayers](doc//PacketFeeContainsICS29RelayerFeesRefundAddressAndOptionalListOfPermittedRelayers.md)
 ...
 - [QueryCodesResponseIsTheResponseTypeForTheQueryCodesRPCMethodPagination](doc//QueryCodesResponseIsTheResponseTypeForTheQueryCodesRPCMethodPagination.md)
 ...
 - [QueryCounterpartyPayeeResponseDefinesTheResponseTypeForTheCounterpartyPayeeRpc](doc//QueryCounterpartyPayeeResponseDefinesTheResponseTypeForTheCounterpartyPayeeRpc.md)
 - [QueryFeeEnabledChannelResponseDefinesTheResponseTypeForTheFeeEnabledChannelRpc](doc//QueryFeeEnabledChannelResponseDefinesTheResponseTypeForTheFeeEnabledChannelRpc.md)
 - [QueryFeeEnabledChannelsResponseDefinesTheResponseTypeForTheFeeEnabledChannelsRpc](doc//QueryFeeEnabledChannelsResponseDefinesTheResponseTypeForTheFeeEnabledChannelsRpc.md)
 - [QueryIncentivizedPacketsResponseDefinesTheResponseTypeForTheIncentivizedPacketRpc](doc//QueryIncentivizedPacketsResponseDefinesTheResponseTypeForTheIncentivizedPacketRpc.md)
 - [QueryIncentivizedPacketsResponseDefinesTheResponseTypeForTheIncentivizedPacketsRPC](doc//QueryIncentivizedPacketsResponseDefinesTheResponseTypeForTheIncentivizedPacketsRPC.md)
 - [QueryIncentivizedPacketsResponseDefinesTheResponseTypeForTheIncentivizedPacketsRpc](doc//QueryIncentivizedPacketsResponseDefinesTheResponseTypeForTheIncentivizedPacketsRpc.md)
 ...
 - [QueryPayeeResponseDefinesTheResponseTypeForThePayeeRpc](doc//QueryPayeeResponseDefinesTheResponseTypeForThePayeeRpc.md)
 ...
 - [QueryTotalAckFeesResponseDefinesTheResponseTypeForTheTotalAckFeesRpc](doc//QueryTotalAckFeesResponseDefinesTheResponseTypeForTheTotalAckFeesRpc.md)
 - [QueryTotalRecvFeesResponseDefinesTheResponseTypeForTheTotalRecvFeesRpc](doc//QueryTotalRecvFeesResponseDefinesTheResponseTypeForTheTotalRecvFeesRpc.md)
 ...
 - [QueryTotalTimeoutFeesResponseDefinesTheResponseTypeForTheTotalTimeoutFeesRpc](doc//QueryTotalTimeoutFeesResponseDefinesTheResponseTypeForTheTotalTimeoutFeesRpc.md)
 ...
 - [QueryUpgradeErrorResponseIsTheResponseTypeForTheQueryQueryUpgradeErrorRPCMethod](doc//QueryUpgradeErrorResponseIsTheResponseTypeForTheQueryQueryUpgradeErrorRPCMethod.md)
 - [QueryUpgradeErrorResponseIsTheResponseTypeForTheQueryQueryUpgradeErrorRPCMethodErrorReceipt](doc//QueryUpgradeErrorResponseIsTheResponseTypeForTheQueryQueryUpgradeErrorRPCMethodErrorReceipt.md)
 - [QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethod](doc//QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethod.md)
 - [QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethodUpgrade](doc//QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethodUpgrade.md)
 - [QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethodUpgradeFields](doc//QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethodUpgradeFields.md)
 - [QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethodUpgradeTimeout](doc//QueryUpgradeResponseIsTheResponseTypeForTheQueryUpgradeResponseRPCMethodUpgradeTimeout.md)
 ...
 - [RatelimitV1QueryRateLimitsByChannelIdResponse](doc//RatelimitV1QueryRateLimitsByChannelIdResponse.md)
 ...
 - [State200Response](doc//State200Response.md)
 - [State200ResponseState](doc//State200ResponseState.md)
 ...
 - [UniquePacketIdentifierComprisedOfTheChannelIDPortIDAndSequence](doc//UniquePacketIdentifierComprisedOfTheChannelIDPortIDAndSequence.md)

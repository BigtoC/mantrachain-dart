...
class CosmosTxV1beta1TxBody {
  /// Returns a new [CosmosTxV1beta1TxBody] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CosmosTxV1beta1TxBody &&
  ...
  @override
  String toString() => 'CosmosTxV1beta1TxBody[messages=$messages, memo=$memo, timeoutHeight=$timeoutHeight, extensionOptions=$extensionOptions, nonCriticalExtensionOptions=$nonCriticalExtensionOptions]';
  ...
  /// Returns a new [CosmosTxV1beta1TxBody] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CosmosTxV1beta1TxBody? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CosmosTxV1beta1TxBody[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CosmosTxV1beta1TxBody[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CosmosTxV1beta1TxBody(
  ...
  static List<CosmosTxV1beta1TxBody> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CosmosTxV1beta1TxBody>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CosmosTxV1beta1TxBody.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CosmosTxV1beta1TxBody> mapFromJson(dynamic json) {
    final map = <String, CosmosTxV1beta1TxBody>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CosmosTxV1beta1TxBody.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CosmosTxV1beta1TxBody-objects as value to a dart map
  static Map<String, List<CosmosTxV1beta1TxBody>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CosmosTxV1beta1TxBody>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CosmosTxV1beta1TxBody.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

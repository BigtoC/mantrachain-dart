...
class FeemarketFeemarketV1Params {
  /// Returns a new [FeemarketFeemarketV1Params] instance.
  FeemarketFeemarketV1Params({
    this.alpha,
    this.beta,
    this.gamma,
    this.delta,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FeemarketFeemarketV1Params &&
    other.alpha == alpha &&
    other.beta == beta &&
    other.gamma == gamma &&
    other.delta == delta &&
  ...
  /// Returns a new [FeemarketFeemarketV1Params] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FeemarketFeemarketV1Params? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FeemarketFeemarketV1Params[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FeemarketFeemarketV1Params[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FeemarketFeemarketV1Params(
  ...
  static List<FeemarketFeemarketV1Params> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FeemarketFeemarketV1Params>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FeemarketFeemarketV1Params.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FeemarketFeemarketV1Params> mapFromJson(dynamic json) {
    final map = <String, FeemarketFeemarketV1Params>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FeemarketFeemarketV1Params.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FeemarketFeemarketV1Params-objects as value to a dart map
  static Map<String, List<FeemarketFeemarketV1Params>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FeemarketFeemarketV1Params>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FeemarketFeemarketV1Params.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

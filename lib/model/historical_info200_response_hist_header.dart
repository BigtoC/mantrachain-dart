...
class HistoricalInfo200ResponseHistHeader {
  /// Returns a new [HistoricalInfo200ResponseHistHeader] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HistoricalInfo200ResponseHistHeader &&
  ...
  /// Returns a new [HistoricalInfo200ResponseHistHeader] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HistoricalInfo200ResponseHistHeader? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HistoricalInfo200ResponseHistHeader[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HistoricalInfo200ResponseHistHeader[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HistoricalInfo200ResponseHistHeader(
        ...
        lastBlockId: PrevBlockInfo.fromJson(json[r'last_block_id']),
  ...
  static List<HistoricalInfo200ResponseHistHeader> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HistoricalInfo200ResponseHistHeader>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HistoricalInfo200ResponseHistHeader.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HistoricalInfo200ResponseHistHeader> mapFromJson(dynamic json) {
    final map = <String, HistoricalInfo200ResponseHistHeader>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HistoricalInfo200ResponseHistHeader.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HistoricalInfo200ResponseHistHeader-objects as value to a dart map
  static Map<String, List<HistoricalInfo200ResponseHistHeader>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HistoricalInfo200ResponseHistHeader>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HistoricalInfo200ResponseHistHeader.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

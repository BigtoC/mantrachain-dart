...
class IbcCoreChannelV1IdentifiedChannel {
  ...
  @override
  String toString() => 'IbcCoreChannelV1IdentifiedChannel[state=$state, ordering=$ordering, counterparty=$counterparty, connectionHops=$connectionHops, version=$version, portId=$portId, channelId=$channelId, upgradeSequence=$upgradeSequence]';
...
class IbcCoreChannelV1IdentifiedChannelStateEnum {
  ...
  static const STATE_FLUSHING = IbcCoreChannelV1IdentifiedChannelStateEnum._(r'STATE_FLUSHING');
  static const STATE_FLUSHCOMPLETE = IbcCoreChannelV1IdentifiedChannelStateEnum._(r'STATE_FLUSHCOMPLETE');
  ...
  IbcCoreChannelV1IdentifiedChannelStateEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'STATE_FLUSHING': return IbcCoreChannelV1IdentifiedChannelStateEnum.STATE_FLUSHING;
        case r'STATE_FLUSHCOMPLETE': return IbcCoreChannelV1IdentifiedChannelStateEnum.STATE_FLUSHCOMPLETE;
        default:
          if (!allowNull) {

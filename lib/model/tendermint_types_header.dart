...
class TendermintTypesHeader {
  /// Returns a new [TendermintTypesHeader] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TendermintTypesHeader &&
  ...
  /// Returns a new [TendermintTypesHeader] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TendermintTypesHeader? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        for (var key in requiredKeys) {
          assert(json.containsKey(key), 'Required key "TendermintTypesHeader[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TendermintTypesHeader[$key]" has a null value in JSON.');
        }
        return true;
      }());

      return TendermintTypesHeader(
  ...
  static List<TendermintTypesHeader> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TendermintTypesHeader>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TendermintTypesHeader.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TendermintTypesHeader> mapFromJson(dynamic json) {
    final map = <String, TendermintTypesHeader>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TendermintTypesHeader.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TendermintTypesHeader-objects as value to a dart map
  static Map<String, List<TendermintTypesHeader>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TendermintTypesHeader>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TendermintTypesHeader.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

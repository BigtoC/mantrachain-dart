...
class CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission {
  ...
  CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission({
    this.permission =
        const CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
            ._('ACCESS_TYPE_UNSPECIFIED'),
  ...
  CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
      permission;
  ...
  bool operator ==(Object other) =>
      ...
      other is CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission &&
  ...
  int get hashCode =>
      ...
      (permission.hashCode) + (addresses.hashCode);

  @override
  String toString() =>
      'CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission[permission=$permission, addresses=$addresses]';
  ...
  static CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermission[$key]" has a null value in JSON.');
        });
        return true;
      }());
...
class CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum {
  ...
  const CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum._(
      this.value);
  ...
  static const ACCESS_TYPE_UNSPECIFIED =
      CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
          ._(r'ACCESS_TYPE_UNSPECIFIED');
  static const ACCESS_TYPE_NOBODY =
      CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
          ._(r'ACCESS_TYPE_NOBODY');
  static const ACCESS_TYPE_EVERYBODY =
      CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
          ._(r'ACCESS_TYPE_EVERYBODY');
  static const ACCESS_TYPE_ANY_OF_ADDRESSES =
      CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
          ._(r'ACCESS_TYPE_ANY_OF_ADDRESSES');
  ...
  static CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum?
      fromJson(dynamic value) =>
          CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnumTypeTransformer()
              .decode(value);
...
class CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnumTypeTransformer {
  factory CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnumTypeTransformer() =>
      _instance ??=
          const CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnumTypeTransformer
              ._();
    ...
    if (data != null) {
      switch (data) {
        case r'ACCESS_TYPE_UNSPECIFIED':
          return CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnum
              .ACCESS_TYPE_UNSPECIFIED;
  ...
  static CodeInfoResponseContainsCodeMetaDataFromCodeInfoInstantiatePermissionPermissionEnumTypeTransformer?
      _instance;
}

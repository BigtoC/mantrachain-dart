...
class DeprecatedPleaseUseSdkBlockInsteadHeader {
  /// Returns a new [DeprecatedPleaseUseSdkBlockInsteadHeader] instance.
  DeprecatedPleaseUseSdkBlockInsteadHeader({
    this.version,
    this.chainId,
    this.height,
    this.time,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DeprecatedPleaseUseSdkBlockInsteadHeader &&
  ...
  /// Returns a new [DeprecatedPleaseUseSdkBlockInsteadHeader] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DeprecatedPleaseUseSdkBlockInsteadHeader? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        for (var key in requiredKeys) {
          assert(json.containsKey(key), 'Required key "DeprecatedPleaseUseSdkBlockInsteadHeader[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DeprecatedPleaseUseSdkBlockInsteadHeader[$key]" has a null value in JSON.');
        }
        return true;
      }());

      return DeprecatedPleaseUseSdkBlockInsteadHeader(
  ...
  static List<DeprecatedPleaseUseSdkBlockInsteadHeader> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DeprecatedPleaseUseSdkBlockInsteadHeader>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DeprecatedPleaseUseSdkBlockInsteadHeader.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DeprecatedPleaseUseSdkBlockInsteadHeader> mapFromJson(dynamic json) {
    final map = <String, DeprecatedPleaseUseSdkBlockInsteadHeader>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DeprecatedPleaseUseSdkBlockInsteadHeader.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DeprecatedPleaseUseSdkBlockInsteadHeader-objects as value to a dart map
  static Map<String, List<DeprecatedPleaseUseSdkBlockInsteadHeader>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DeprecatedPleaseUseSdkBlockInsteadHeader>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DeprecatedPleaseUseSdkBlockInsteadHeader.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

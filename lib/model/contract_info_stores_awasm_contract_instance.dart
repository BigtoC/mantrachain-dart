...
class ContractInfoStoresAWASMContractInstance {
  ...
  @override
  String toString() => 'ContractInfoStoresAWASMContractInstance[codeId=$codeId, creator=$creator, admin=$admin, label=$label, created=$created, ibcPortId=$ibcPortId, ibc2PortId=$ibc2PortId, extension_=$extension_]';

...
class CosmosSlashingV1beta1ValidatorSigningInfo {
  /// Returns a new [CosmosSlashingV1beta1ValidatorSigningInfo] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CosmosSlashingV1beta1ValidatorSigningInfo &&
  ...
  @override
  String toString() => 'CosmosSlashingV1beta1ValidatorSigningInfo[address=$address, startHeight=$startHeight, indexOffset=$indexOffset, jailedUntil=$jailedUntil, tombstoned=$tombstoned, missedBlocksCounter=$missedBlocksCounter]';
  ...
  /// Returns a new [CosmosSlashingV1beta1ValidatorSigningInfo] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CosmosSlashingV1beta1ValidatorSigningInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CosmosSlashingV1beta1ValidatorSigningInfo(
  ...
  static List<CosmosSlashingV1beta1ValidatorSigningInfo> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CosmosSlashingV1beta1ValidatorSigningInfo>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CosmosSlashingV1beta1ValidatorSigningInfo.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CosmosSlashingV1beta1ValidatorSigningInfo> mapFromJson(dynamic json) {
    final map = <String, CosmosSlashingV1beta1ValidatorSigningInfo>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CosmosSlashingV1beta1ValidatorSigningInfo.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CosmosSlashingV1beta1ValidatorSigningInfo-objects as value to a dart map
  static Map<String, List<CosmosSlashingV1beta1ValidatorSigningInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CosmosSlashingV1beta1ValidatorSigningInfo>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CosmosSlashingV1beta1ValidatorSigningInfo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
